## What does Twitter latest scraper do?

Twitter latest scraper will enable you to get more data from [Twitter.com](https://twitter.com/home) than the official Twitter.com API.

Twitter latest scraper can scrape:
...
It's easy to scrape [Twitter.com](https://twitter.com/home) with Twitter latest scraper. Just follow these few steps and you'll get your data in a few minutes.
...
Apify gives you with \$5 free usage credits every month on the Apify Free plan. You can get 20,000 results per month from Twitter latest scraper for that, so those 20k results will be completely free!
